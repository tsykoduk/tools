...
# generate a 10000kB file of all random stuff
...
bit=8
up_bits=$(echo "$up_speed * $bit / 1024" | bc )
down_bits=$(echo "$down_speed * $bit / 1024" | bc )

# print result
echo ""
echo "Upload speed:   $up_speed kB/s or $up_bits Mbps"
echo "Download speed: $down_speed kB/s or $down_bits Mbps"
